...
public class SignupOne extends JFrame implements ActionListener{
    ...
    JRadioButton male,female,other,married,ummarrid;
    ...
    SignupOne(){
        ...
        JLabel personalDelails = new JLabel("Page 1: Personal Details");
        personalDelails.setFont(new Font("Raleway",Font.BOLD,22));
        personalDelails.setBounds(290,80,400,30);
        add(personalDelails);
        ...
        add(marital);
            ...
            ummarrid = new JRadioButton("Unmarried");
            ummarrid.setBounds(450,390,100,30);
            ummarrid.setBackground(Color.WHITE);
            add(ummarrid);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            if(name.equals("")){
                JOptionPane.showMessageDialog(null,"Name is Requride");
            } else{
                Conn c = new Conn();
